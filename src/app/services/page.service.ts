...
export type Page = "home" | "table" | "addcase" | "newtemplate" | "pttemplate" | "variant_list" | "help";

const validPages = ["home", "table", "addcase", "newtemplate", "pttemplate", "variant_list", "help"] as const;
